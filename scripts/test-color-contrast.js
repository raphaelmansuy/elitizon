...
function analyzeColorCombinations() {
  ...
  const combinations = [
    // Navigation
    { name: 'Navigation Text', fg: colors['gray-700'], bg: colors['white'], component: 'Navigation' },
    { name: 'Nav Hover State (FIXED)', fg: '#be185d', bg: colors['secondary-50'], component: 'Navigation' }, // pink-700
    
    // Hero Section
    { name: 'Hero Main Text', fg: colors['white'], bg: colors['primary-800'], component: 'Hero' },
    { name: 'Hero Pink Accent', fg: colors['secondary-400'], bg: colors['primary-800'], component: 'Hero' },
    
    // Services Section - Critical Area
    { name: 'Service Card Text (FIXED)', fg: colors['primary-700'], bg: colors['secondary-50'], component: 'Services', critical: true },
    { name: 'Service Card Text (OLD - FAILING)', fg: colors['secondary-400'], bg: colors['white'], component: 'Services', critical: true, deprecated: true },
    { name: 'Service Features (FIXED)', fg: colors['primary-900'], bg: colors['white'], component: 'Services' },
    
    // About Section
    { name: 'About Headers', fg: colors['primary-700'], bg: colors['white'], component: 'About' },
    { name: 'About Body Text', fg: colors['gray-700'], bg: colors['white'], component: 'About' },
    
    // Contact Section
    { name: 'Form Labels', fg: colors['primary-700'], bg: colors['white'], component: 'Contact' },
    { name: 'Form Borders (FIXED)', fg: colors['primary-400'], bg: colors['white'], component: 'Contact' },
    { name: 'Error Messages (FIXED)', fg: '#b91c1c', bg: colors['white'], component: 'Contact' }, // red-700
    
    // Footer
    { name: 'Footer Text', fg: colors['gray-300'], bg: colors['gray-800'], component: 'Footer' },
    { name: 'Footer Links', fg: colors['white'], bg: colors['gray-800'], component: 'Footer' },
    { name: 'Footer Pink Hover', fg: colors['secondary-400'], bg: colors['gray-800'], component: 'Footer' },
    
    // Buttons & CTAs
    { name: 'Primary Button (FIXED)', fg: colors['white'], bg: '#be185d', component: 'Buttons' }, // pink-700
    { name: 'Secondary Button', fg: colors['primary-700'], bg: colors['white'], component: 'Buttons' },
  ];
  ...
  Object.keys(grouped).forEach(component => {
    ...
    grouped[component].forEach(combo => {
      ...
      console.log(`   ${formatRatio(ratio)} - ${level} ${combo.critical ? '(CRITICAL)' : ''}`);
  ...
  console.log('\n🔗 USEFUL RESOURCES');
  console.log('====================');
  console.log('• WCAG Contrast Checker: https://webaim.org/resources/contrastchecker/');
