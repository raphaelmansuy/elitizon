...
export default function SocialShare({
  ...
  const platforms = [
    ...
    },
    {
      ...
      bgColor: copied ? "bg-green-500" : "hover:bg-gray-200",
      textColor: copied ? "text-white" : "hover:text-gray-800",
    },
  ];
      ...
      <div className="flex items-center gap-1.5">
        {platforms.map((platform) => (
          <button
            ...
            className={`
              p-2.5 rounded-lg text-gray-500 transition-all duration-200 
