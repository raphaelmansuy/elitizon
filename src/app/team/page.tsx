...
export default function TeamPage() {
  const leadership = [
    {
      ...
      role: "Founder & CEO",
      location: "Hong Kong",
      expertise: ["Strategic Leadership", "Business Development", "AI Strategy"],
  ...
  const expertiseAreas = [
    ...
    },
    {
      ...
      skills: ["LLMs", "RAG Systems", "AI Agents", "Prompt Engineering", "Fine-tuning"]
    },
    {
      area: "Cloud & DevOps",
      experts: 10,
  ...
  const benefits = [
    {
      ...
      description: "Work with our experts on project basis or long-term partnerships",
      icon: "🔄"
    },
    {
      title: "Time Zone Coverage",
      description: "European experts aligned with Asian business hours when needed",
      icon: "🌍"
    },
    {
    ...
    },
    {
      ...
      description: "Ongoing mentorship and knowledge transfer throughout projects",
      icon: "🤝"
    }
  ]
