                ...
                <div key={index} className="relative flex items-start">
                  ...
                  <div className="ml-8">
                    <div className="flex items-center mb-2">
                      <span className="text-pink-600 font-bold text-lg mr-4">{item.year}</span>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Global Perspective, Local Expertise</h3>
                    <p className="text-slate-600">Unique blend of Asian business understanding and European technical excellence</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Access to Europe&apos;s finest freelance specialists, carefully vetted for excellence</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Cutting-Edge Technology</h3>
                    <p className="text-slate-600">Always at the forefront of AI, ML, and data engineering innovations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Successful delivery of complex projects across multiple industries</p>
                  </div>
                </div>
              </div>
            </div>
